...
const Download = () => {
  return (
    <div className="bg-yellow-400 mx-2 md:mx-16 my-4 md:my-20 rounded-full pl-[10px] relative top-[-2rem]">
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-col-reverse md:flex-row items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-2 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center px-20">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mx-auto md:ml-0 mt-[-5rem]">

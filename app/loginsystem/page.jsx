          ...
          <div class="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:px-0 items-end sm:space-x-4 sm:space-y-0 space-y-4">
            <div class="relative sm:mb-0 flex-grow w-full text-center">
              <label for="full-name" class="leading-7 text-sm text-gray-400">
                Enter Your Email to Login this
              </label>
              <input
                type="text"
                id="email"
...
{
  /* <button className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded-full text-lg mt-[10px]">
                submit
              </button>
            </div> */
}
